...
button1 = tk.Button(window, text = "flying transect line" , fg = "red", width = 13, height = 5, command = read_video)
button1.place(x=185, y= 100)

   # the button for color detection mission

button2 = tk.Button(window, text = "coral color" , fg = "green", width = 13, height = 5, command = colonyhealthfunction)
...
button4 = tk.Button(window, text = "camera 0" , fg = "black", width = 10, height = 2, command = changeString)
button4.place(x=100, y= 400)

   # button for camera 1

button5 = tk.Button(window, text = "camera 1" , fg = "black", width = 10, height = 2, command = changeString)
